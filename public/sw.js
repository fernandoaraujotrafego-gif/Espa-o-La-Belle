...
self.addEventListener('fetch', (event) => {
  ...
  if (
    ...
    return; // Dynamic execution directly over network
  }

  // Network-First for pages/navigation to guarantee real-time layout
  ...
  // Cache-First for versioned static assets, icons and fonts
  const isStatic =
